...
// ⚠️ USE O SEU IP AQUI ⚠️
const API_URL = 'http://10.110.12.42:3000';
...
function Albuns() {
    ...
    const loadPhotos = async () => {
        try {
            ...
            setPhotos([
                { id: 1, titulo_foto: "Bem-vindo ao Álbum!", descricao_foto: "Toque em 'Nova Foto' para adicionar suas fotos", data_foto: new Date().toISOString(), uri: "https://via.placeholder.com/300x200/4CAF50/FFFFFF?text=App+Albuns" }
            ]);
        }
    };
